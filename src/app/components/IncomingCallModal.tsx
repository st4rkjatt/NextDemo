...
export default function IncomingCallModal({handleAccept, handleReject}: {handleAccept: () => void, handleReject: () => void }) {
  ...
  return (
    ...
    <div className=" bg-gray-900 text-white p-6 rounded-xl shadow-xl w-[40%] h-[60vh]  ">
      <div className="grid grid-cols-1 gap-4 text-center h-full  place-items-center">
        ...
        <h2 className="text-xl font-semibold mt-4">John Doe is calling...</h2>
