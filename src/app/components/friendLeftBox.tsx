    ...
    return <>
        ...
        <div className=" flex-1 overflow-auto ">
            ...
            {allUsers?.map((user: any) => {
                return <div className="px-3 flex items-center bg-grey-light cursor-pointer border-b border-grey hover:bg-amber-50 hover:shadow-md" onClick={() => setSelectedChatUser(user)}>
                    <div>
