...
"[project]/src/app/models/conversationMode.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const MessageModel = __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].model("message", messageSchema);
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$conversationMode$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/models/conversationMode.ts [app-route] (ecmascript)");
...
async function POST(request, { params }) {
    try {
        ...
        const chatExists = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$conversationMode$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOne({
            participants: {
                $all: [
                    senderId,
                    receiverId
        ...
        if (!chatExists) {
            const conversation = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$conversationMode$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].create({
                participants: [
                    senderId,
                    receiverId
                ]
        ...
        const updateChat = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$conversationMode$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOneAndUpdate({
            participants: {
                $all: [
                    senderId,
                    receiverId
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a7980ddc._.js.map