...
async function GET(request) {
    try {
        const userId = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$utils$2f$helper$2f$getDataToken$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getDataToken"])(request);
        if (!userId) {
        ...
        const result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$userModel$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find({
            _id: {
                $ne: userId
            }
        }).select("-password");
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e0829121._.js.map